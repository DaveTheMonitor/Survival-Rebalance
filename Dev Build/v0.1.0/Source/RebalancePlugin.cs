...
namespace DaveTheMonitor
{
    public class RebalancePlugin : ITMPlugin
    {
        ...
        #region GUI
        string indevText = "Survival Rebalance Dev Build v0.1.0";
        ...
        void ITMPlugin.Update()
        {
            ...
            if (timer > config.TierUpdateInterval)
            {
                ...
                if (rebalanceData.HighestTier != 7)
                {
                    ...
                    {
                        player.TakeDamageAndDisplay(DamageType.Combat, 30, new Vector3(0, 0, 1), player, Item.None, StudioForge.BlockWorld.SkillType.Strength);
